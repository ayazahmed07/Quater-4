    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-8">
                  ...
                  <div className="col-span-2">
                    {formData.quantity && formData.rate && (
                      <p className="text-sm text-gray-600">
                        Total Value: Rs. {(formData.quantity * formData.rate).toFixed(2)}
                      </p>
                    )}
                  </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle>Purchase History ({purchases?.length || 0})</CardTitle>
            </CardHeader>
            <CardContent>
              <Table>
                <TableHeader>
                ...
                <TableBody>
                  {purchases?.map((purchase) => (
                    <TableRow key={purchase.purchase_id}>
                      ...
                      <TableCell className="text-right">Rs. {(purchase.quantity * purchase.rate).toFixed(2)}</TableCell>
                    </TableRow>
                  ))}
                </TableBody>
              </Table>
